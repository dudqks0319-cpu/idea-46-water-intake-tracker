...
import 'package:app_46_water_intake_tracker/app.dart';
import 'package:app_46_water_intake_tracker/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('수분 섭취 트래커'), findsWidgets);
